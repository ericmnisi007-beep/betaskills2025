...
-- This version includes user_email AND course_title columns
...
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'cybersecurity101', 'Cybersecurity 101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'emotional-intelligence', 'Emotional Intelligence', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'prophet', 'Prophet', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'entrepreneurship-final', 'Entrepreneurship Final', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'ai-assisted-programming', 'AI Assisted Programming', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'ai-assisted-web-development', 'AI Assisted Web Development', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'christian-teacher', 'Christian Teacher', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'podcast-management-101', 'Podcast Management 101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'sound-engineering-102', 'Sound Engineering 102', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'computer-repairs', 'Computer Repairs', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'roofing', 'Roofing', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'plumbing', 'Plumbing', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'tiling-101', 'Tiling 101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'hair-dressing', 'Hair Dressing', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'nail-technician', 'Nail Technician', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'petrol-motor-mechanic', 'Petrol Motor Mechanic', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'diesel-motor-mechanic', 'Diesel Motor Mechanic', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'landscaping', 'Landscaping', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'social-media-marketing-101', 'Social Media Marketing 101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'master-electrician-online', 'Master Electrician Online', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'beauty-therapy-101', 'Beauty Therapy 101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'dog-grooming-101', 'Dog Grooming 101', 'active', NOW(), 0
