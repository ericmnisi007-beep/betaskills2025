...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'cybersecurity101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'emotional-intelligence', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'prophet', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'entrepreneurship-final', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'ai-assisted-programming', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'ai-assisted-web-development', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'christian-teacher', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'podcast-management-101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'sound-engineering-102', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'computer-repairs', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'roofing', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'plumbing', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'tiling-101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'hair-dressing', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'nail-technician', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'petrol-motor-mechanic', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'diesel-motor-mechanic', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'landscaping', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'social-media-marketing-101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'master-electrician-online', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'beauty-therapy-101', 'active', NOW(), 0
...
INSERT INTO public.enrollments (user_id, course_id, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'dog-grooming-101', 'active', NOW(), 0
