-- FINAL WORKING VERSION - Grant access to all 22 courses for maxmon2@gmail.com
-- Status must be 'pending' not 'active' based on the constraint
...
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'cybersecurity101', 'Cybersecurity 101', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'emotional-intelligence', 'Emotional Intelligence', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'prophet', 'Prophet', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'entrepreneurship-final', 'Entrepreneurship Final', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'ai-assisted-programming', 'AI Assisted Programming', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'ai-assisted-web-development', 'AI Assisted Web Development', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'christian-teacher', 'Christian Teacher', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'podcast-management-101', 'Podcast Management 101', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'sound-engineering-102', 'Sound Engineering 102', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'computer-repairs', 'Computer Repairs', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'roofing', 'Roofing', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'plumbing', 'Plumbing', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'tiling-101', 'Tiling 101', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'hair-dressing', 'Hair Dressing', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'nail-technician', 'Nail Technician', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'petrol-motor-mechanic', 'Petrol Motor Mechanic', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'diesel-motor-mechanic', 'Diesel Motor Mechanic', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'landscaping', 'Landscaping', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'social-media-marketing-101', 'Social Media Marketing 101', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'master-electrician-online', 'Master Electrician Online', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'beauty-therapy-101', 'Beauty Therapy 101', 'pending', NOW(), 0
...
INSERT INTO public.enrollments (user_id, user_email, course_id, course_title, status, enrolled_at, progress)
SELECT (SELECT id FROM auth.users WHERE email = 'maxmon2@gmail.com'), 'maxmon2@gmail.com', 'dog-grooming-101', 'Dog Grooming 101', 'pending', NOW(), 0
